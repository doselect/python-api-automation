"""Mirrors tests/public_apis/fn/test_fn_get_html_report.py (do-api-automation)."""
...
def test_fn_get_html_report(fn_response_handler: FnResponseHandler, request):
    response = fn_response_handler.get_html_report(FN_HTML_REPORT_TRANSCRIPT_ID)
