"""Mirrors tests/public_apis/fn/test_fn_try_this_test.py (do-api-automation)."""
...
def test_fn_try_this_test(fn_response_handler: FnResponseHandler, request):
    payload = {
        "is_sample": "True",
        "fn_transcript_id": generate_random_string(),
        "fn_attempt_id": "sampleattempt1",
