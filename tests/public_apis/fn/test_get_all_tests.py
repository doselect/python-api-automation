"""Mirrors tests/public_apis/fn/test_get_all_tests.py (do-api-automation)."""
...
def test_get_all_tests(fn_response_handler: FnResponseHandler, request):
    response = fn_response_handler.get_all_tests(FN_COMPANY_SLUG)
