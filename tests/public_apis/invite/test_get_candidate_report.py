"""Mirrors tests/public_apis/invite/test_get_candidate_report.py (do-api-automation)."""
...
@pytest.mark.public
def test_get_candidate_report(invite_response_handler: InviteResponseHandler, request):
    response = invite_response_handler.get_candidate_report(TEST_SLUG_RECRUIT, CANDIDATE_EMAIL)
