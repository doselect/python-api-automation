"""Mirrors tests/public_apis/invite/test_get_one_test.py (do-api-automation)."""
...
@pytest.mark.public
def test_get_one_test(invite_response_handler: InviteResponseHandler, request):
    response = invite_response_handler.get_one_test(TEST_SLUG_RECRUIT)
