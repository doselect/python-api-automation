"""Mirrors tests/public_apis/problems/test_get_one_submission.py (do-api-automation)."""
...
@pytest.mark.public
def test_get_one_submission(problems_response_handler: ProblemsResponseHandler, request):
    response = problems_response_handler.get_one_submission(SOLUTION_SLUG)
