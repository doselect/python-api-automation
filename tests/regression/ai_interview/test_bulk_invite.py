"""Mirrors tests/test_regression/test_ai_interview/test_bulk_invite.py (do-api-automation)."""
...
@pytest.mark.post_invite
@pytest.mark.run(order=3)
@pytest.mark.ai_interview
def test_post_invite(
    ...
    ai_interview_response_handler.post_invite_ai_interview(slug)
